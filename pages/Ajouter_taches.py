...
priorite = st.selectbox("Sélectionner la priorité", ["faible", "moyenne", "élevé"])
categorie = st.selectbox("Séléctionner type de tâche", ["travail", "études", "personnel", "santé"])
col1, col2 = st.columns(2)
with col1:
    btn1 = st.button("Ajouter")


if btn1 ==True:
    t=task(titre, description, date_echeance, priorite, categorie)
    m.ajouter_tache(t)
    st.success(f"Tâche ajouter avec succès.")
